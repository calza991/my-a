export default function product() {
    return(
      ...
      <div className="group">
      <button className="w-full transition-all duration-150 bg-blue-700 text-white border-b-8 border-b-blue-700 rounded-lg group-hover:barder-b-0 group-hover:bg-blue-700 group-hover:shadow-lg">
      ...
      <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:traslate-y-0.5 transition-all duration-150">
      <img src="images/carrello.png" alt="" className="w-8"/>
