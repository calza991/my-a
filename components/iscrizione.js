export default function Iscrizione() {
    return(
      <>
        ...
        <div className="flex flex-col md:flex-row rounded-1-xl">
        <img
        src="images/immagine.jpg"
        alt=""
        ...
        <p className="max-w-xs my-4 text-xs leading-5 tracking-wide text-center text-white md:text-left">
          Eat better and exercise better. Sing up for the Diet&Fintness 
          newsletter.
        </p>
        ...
        <div className="flex flex-col mt-5 space-y-4 md:space-x-3 md:flex-row md:space-y-0">
         <input
           ...
           className="p-2 px-4 text-center text-white bg-zinc-800 border bonder-zinc-600 placeholder:text-xs placeholder:text-center md:text-left placeholder:md:text-left focus:outline-none"
         />

         <button className="px-5 py-3 text-xs rounded-md text-zinc-800 bg-lime-500 hover:bg-red-700 hover:text-white duration-500">
           Subcribe 
                  </button>
                </div>
              </div>
