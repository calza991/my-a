      ...
      <div className="flex flex-col my-6 space-y-6 md:space-y-0 md:space-x-6 md:flex-row md:my-0">
        <div className="bg-slate-700 rounded-xl text-white">
          ...
          <div className="flex justify-center"> 
            <a
              href="#"
              className="inline-block px-10 py-3 my-6 text-center border border-violent-600 rounded-lg duration-200 bg-violet-600 hover:bg-violent-800 hover:border-violet-800"
            >
              Purchase
               </a>
             </div>  
